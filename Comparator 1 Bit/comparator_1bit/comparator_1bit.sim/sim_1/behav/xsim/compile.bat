...
REM
REM Generated by Vivado on Mon Jan 26 10:56:57 +0530 2026
...
echo "xvlog --incr --relax -prj tb_comparator_1bit_vlog.prj"
call xvlog  --incr --relax -prj tb_comparator_1bit_vlog.prj -log xvlog.log
