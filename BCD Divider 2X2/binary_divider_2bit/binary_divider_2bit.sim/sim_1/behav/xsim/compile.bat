...
REM
REM Generated by Vivado on Sun Jan 25 20:10:45 +0530 2026
...
echo "xvlog --incr --relax -prj tb_binary_divider_2bit_vlog.prj"
call xvlog  --incr --relax -prj tb_binary_divider_2bit_vlog.prj -log xvlog.log
