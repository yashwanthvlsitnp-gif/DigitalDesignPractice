...
HD_PWD='E:/HDL_2026/Week_1/Day_2/Practice/Binary Divider 2 bit/binary_divider_2bit/binary_divider_2bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_binary_divider_2bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_binary_divider_2bit.tcl
