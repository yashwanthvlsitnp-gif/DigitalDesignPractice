...
HD_PWD='E:/HDL_2026/Week_1/Day_2/Practice/BCD_Adder/bcd_subtractor/bcd_subtractor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_bcd_subtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_bcd_subtractor.tcl
