...
REM
REM Generated by Vivado on Thu Jan 22 23:45:25 +0530 2026
...
echo "xvlog --incr --relax -prj tb_bcd_subtractor_vlog.prj"
call xvlog  --incr --relax -prj tb_bcd_subtractor_vlog.prj -log xvlog.log
