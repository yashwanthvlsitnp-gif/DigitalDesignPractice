...
HD_PWD='E:/HDL_2026/Week_1/Day_2/Practice/Binary Array Multiplier_2X2/binary_array_multiplier_2x2/binary_array_multiplier_2x2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_binary_array_multiplier_2x2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_binary_array_multiplier_2x2.tcl
