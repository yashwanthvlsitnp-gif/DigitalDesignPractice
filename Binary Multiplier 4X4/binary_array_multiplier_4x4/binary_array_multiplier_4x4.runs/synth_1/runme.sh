...
HD_PWD='E:/HDL_2026/Week_1/Day_2/Practice/Binary Array Multiplier_4X4/binary_array_multiplier_4x4/binary_array_multiplier_4x4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_binary_array_multiplier_4x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_binary_array_multiplier_4x4.tcl
